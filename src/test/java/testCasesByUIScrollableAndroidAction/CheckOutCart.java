package testCasesByUIScrollableAndroidAction;/*
package testCases;
...
public class CheckOutCart extends BaseTest {
    ...
    public void prepareTestDataForLogin() throws IOException, SQLException {
        ...
        JSONObject obj1 = JDBC.setJsonObjectFromDBForNestedArrayOfJsonObjects(dbQuery1,jsonKeysForUsers,jsonMainKeyForUsers);
        JSONObject obj2 = JDBC.setJsonObjectFromDBForNestedArrayOfJsonObjects(dbQuery2,jsonKeysForMassages,jsonMainKeyForMassages);
    ...
    public void prepareTestDataForProducts() throws IOException, SQLException {
        ...
        JDBC.setJsonFileFromDBForNestedArrayOfJsonObjects(dbQuery,jsonFilePath,jsonKeys,jsonMainKey);
    }
    ...
    @Test
     public void checkOutCart() throws IOException, ParseException {
        new LoginPage(driver)
                ...
                .scrollDownToProduct(json2.getValueFromArray("Products[1].Name"))
                .addProductToCartByDragAndDrop(json2.getValueFromArray("Products[1].Name"))
                .scrollUpToProduct(json2.getValueFromArray("Products[2].Name"))
                ...
                */
/*.assertProductIsAddedToCart(json2.getValueFromArray("Products[0].Name"))
                ...
                .scrollDownToProduct(json2.getValueFromArray("Products[2].Name"))
                ...
                .verifyTotalPriceOfProducts("51.81")
                .softAssertAll();
    }
