...
public class AndroidDriverManager {
    ...
    public static AppiumDriver openApp() throws MalformedURLException {
        return new AndroidDriver(getAppiumServerURL(),getAppiumCapabilities());
    }
    ...
    public static DesiredCapabilities getAppiumCapabilities()
    {
        ...
        cap.setCapability("appium:app", System.getProperty("user.dir")+"\\src\\test\\resources\\Apps\\Android.SauceLabs.Mobile.Sample.app.2.7.1.apk");
